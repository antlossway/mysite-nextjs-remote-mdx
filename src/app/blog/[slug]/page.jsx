...
export default async function Post({ params }) {
  ...
  return (
    <>
      <main
        className="px-6 py-6 mx-auto prose prose-base md:prose-lg prose-slate dark:prose-invert prose-a:text-blue-500 prose-a:no-underline hover:prose-a:underline
        "
      >
