  ...
  return (
    <div className='max-w-xl px-4 pt-4 border rounded-lg border-gray-300 shadow-md '>
        <form onSubmit={handleSubmit}
            ...
            <button className=' px-4 py-3 w-full bg-gray-700 text-white font-semibold hover:bg-gray-500 active:translate-y-1 transition-all
            disabled:bg-gray-400 disabled:cursor-not-allowed'
            type='submit'
            disabled={formStatus === 'loading'}>Send</button>
